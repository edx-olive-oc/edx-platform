...
class AccessibilityPage(IndexPage):
    ...
    def submit_form(self):
        ...
        button.click()
        # For some reason, button clicking is flaky :( so click it twice to be sure.
        button.click()
        self.wait_for_ajax()
    ...
    def success_alert_shown(self):
        """
        Check that there is an alert dialog shown with the successful submit message.
        """
        self.wait_for_element_visibility('#root div.alert-dialog', 'Form submit success alert is visible')
        return self.alert_has_text('Thank you for contacting edX!')

    def error_alert_shown(self):
        """
        Check that there is an alert dialog shown with the submit error message.
        """
        self.wait_for_element_visibility('#root div.alert-dialog', 'Form submit error alert is visible')
        return self.alert_has_text('Please fill in all required fields')
